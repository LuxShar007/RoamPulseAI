...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/SQLite3-DB-003B57?style=for-the-badge&logo=sqlite&logoColor=white" alt="SQLite" />
...
Below are the key software tools, frameworks, and technologies powering **RoamPulse AI**:
...
| **Express.js** | Backend Server | RESTful API server for OpenStreetMap, Google Reviews, & DB | `![Express](https://img.shields.io/badge/Express.js-000000?style=flat-square&logo=express&logoColor=white)` |
| **SQLite3 & Prisma** | Database / ORM | Persistent storage for itineraries, bookings, and places | `![SQLite](https://img.shields.io/badge/SQLite-003B57?style=flat-square&logo=sqlite&logoColor=white)` |
...
2. **🗺️ Real-Time OpenStreetMap Venue Radar**:
   - Discovers real-world accommodations, street food spots (LocoGems), restaurants, public washrooms, and medical hubs.

3. **⭐ Google Review Data & AI Summaries**:
...
6. **💰 Multi-Currency Support**:
   - Supports 6 global currencies: **₹ INR**, **$ USD**, **€ EUR**, **£ GBP**, **AED**, and **¥ JPY**.

7. **🌬️ Live Weather & AQI Radar**:
   - Real-time temperature and Air Quality Index (AQI) monitoring.

---

## 👥 Creator Team Members

This project was designed, developed, and created by:
...
```bash
# Launch Vite Dev Server (Runs on http://localhost:3000)
npm run dev
```
...
## 📄 License
Created for academic and innovation project demonstration. All rights reserved by the Creator Team.
